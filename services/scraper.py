from config.configs import connect_web_proxy
from urllib.parse import quote
from selenium.webdriver.common.by import By

"""
This module should have some predefined websites where yall want to scrpe your data from

possible methods
scrape bloomburg
scrape yahoo finnace
"""
class Scraper():
    def __init__(self):
